...
* **Usage:** Simply input your CSV tracking cell counts across different days and treatments, and the script outputs publication-ready, high-resolution growth curves.
* **Why open-source?** We aim to help wet-lab researchers (especially those working with mouse models or cell culture) save time on repetitive data plotting, minimizing human error in statistical visualization.
